...
char *fromIntToChar(long long int br){
    ...
    char *singleDigits[]={"","one","two","three","four","five",
                          "six","seven","eight","nine","ten","eleven","twelve",
                          "thirteen","fourteen","fifteen","sixteen","seventeen",
                          "eighteen","nineteen"};
    char *tensMultiple[]={"","twenty","thirty","forty","fifty","sixty",
...
//write a letter you don't want to have in a number.
//and find the biggest number without that letter in it.
...
int main() {
    ...
    for(long long int i=LIM;i>=1;i--){
     ...
     if(max(i-1,i)&& strpbrk(Number, letter) == NULL)
       {
            printf("\n%lld: ",i);
           printf("%s",Number);
           break;
